...
export default class ValidatedControl extends FormControl {
    constructor(props) {
        super(props);
...
ValidatedControl.propTypes = Object.assign({}, FormControl.propTypes, {
...
ValidatedControl.defaultProps = Object.assign({}, FormControl.defaultProps, {
    validationEvent: ''
});
